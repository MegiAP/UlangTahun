package com.ulangtahun.receiver;
...
//        Toast.makeText(context, title + " : " + message, Toast.LENGTH_LONG).show();
    ...
    public void setOneTimeAlarm(Context context, String type, String date, String time, String message, int id) {
...
//        Toast.makeText(context, "Alarm Telah dibuat", Toast.LENGTH_SHORT).show();
    }
...
//    public void cancelAlarm(Context context, String type, int id) {
//        AlarmManager alarmManager = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
//        Intent intent = new Intent(context, AlarmReceiver.class);
